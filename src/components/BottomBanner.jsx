...
import bottom_sm from '../assets/bottom_banner_sm.png';
import bottom from '../assets/bottom_banner.png';
import { features } from '../assets/assets';

const BottomBanner = () => {
  return (
    <div className='relative mt-24'>
        <img src={bottom} alt="banner" className='w-full hidden md:block' />
        <img src={bottom_sm} alt="banner" className='w-full md:hidden'/>
